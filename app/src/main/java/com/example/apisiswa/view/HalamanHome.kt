...
import com.example.apisiswa.viewmodel.HomeViewModel
import com.example.apisiswa.viewmodel.PenyediaViewModel
import com.example.apisiswa.R
import com.example.apisiswa.uicontroller.DestinasiHome
import com.example.apisiswa.viewmodel.StatusUiSiswa
...
fun ErrorScreen(retryAction: () -> Unit, modifier: Modifier= Modifier){
    Column (
        ...
        Button(onClick = retryAction) {
            Text(stringResource(R.string.rentry))
